...
```{r Inlezen .csv}
nse_benchmark <- read.csv2("~/research-drive/M21033303_DenA (Projectfolder)/DA_Onderzoek/2021nse/data_in/NSE2021 Definitief Benchmarkbestand permutatie.csv")
...
save(nse_benchmark_clean, NSEvragen, vec_NSEvragen, file = "~/research-drive/M21033303_DenA (Projectfolder)/DA_Onderzoek/2021nse/data_in/NSE2021 nse_benchmark_clean.RData")
```