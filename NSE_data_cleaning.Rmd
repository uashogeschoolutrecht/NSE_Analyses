...
```{r Inlezen .csv}
NSEjaar <- 2022 #Kies eenmalig het NSE jaar
if(NSEjaar == 2022)
{
  nse_benchmark <- read.csv2("~/researchdrive/M21033303_DenA (Projectfolder)/DA_Onderzoek/2022nse/data_in/NSE2022 Definitief Benchmarkbestand (2021-2022).csv")
} else if(NSEjaar == 2021)
{
...
save(nse_benchmark_clean, #gecleande data
     ...
     vec_NSEvragen,       #vector met vraagnummers iets meer commentaar
     ...
     ind_exclusie,        #index exclusievraag nog meer commentaar
     ...
     file = paste("~/researchdrive/M21033303_DenA (Projectfolder)/DA_Onderzoek/", NSEjaar, "nse/data_in/NSE", NSEjaar, " nse_benchmark_clean.RData", sep = "")
     )
```