...
```{r Inlezen .csv}
NSEjaarT1 = 2025 #Kies NSE vergelijkingsjaar (oudste jaar)
...
NSEjaar = 2026 # Kies het NSE jaar om te analyseren als nieuwste jaar
    ...
    for (i_ho in 1:NHO)
    {
      ...
      for (i_vorm in 1:int_vorm)
      {
        ...
        for (i_vraag in vec_NSEvragen)
        {
          ...
          #Groepsgroote moet minimaal 5 responses zijn en exclusie vragen worden overgeslagen
