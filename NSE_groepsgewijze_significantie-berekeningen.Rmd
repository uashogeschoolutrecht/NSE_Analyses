  ...
  for (i_ho in 1:NHO)
  {
    ...
    for (i_vorm in 1:Nvorm)
    {
      ...
      for (i_vraag in vec_NSEvragen)
      {
        ...
        diff_HUR6[i_vraag-Ncor,i_vorm,i_ho,i_croho, i_instituut] <-gem_HU[i_vraag-Ncor,i_vorm,i_ho,i_croho, i_instituut]
        -gem_R6[i_vraag-Ncor,i_vorm,i_ho,i_croho, i_instituut]
        diff_HUAL[i_vraag-Ncor,i_vorm,i_ho,i_croho, i_instituut] <-gem_HU[i_vraag-Ncor,i_vorm,i_ho,i_croho, i_instituut]
        -gem_AL[i_vraag-Ncor,i_vorm,i_ho,i_croho, i_instituut]
