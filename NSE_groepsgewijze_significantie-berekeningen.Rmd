...
for (i_ho in 1:NHO)
{
  ...
  #Berekenen gemiddelden per groep
      gem_HU[i_vraag-Ncor,i_vorm,i_ho]  <- mean(HUscores[vec_HO[[i_ho]]&                                                                 vec_vorm[[i_vorm]]                                                             ,i_vraag], na.rm = TRUE)
      gem_R6[i_vraag-Ncor,i_vorm,i_ho]  <- mean(R6scores[vec_HO[[i_ho]]&                                                                 vec_vorm[[i_vorm]]                                                             ,i_vraag], na.rm = TRUE)
      gem_AL[i_vraag-Ncor,i_vorm,i_ho]  <- mean(ALscores[vec_HO[[i_ho]]&                                                                 vec_vorm[[i_vorm]]                                                             ,i_vraag], na.rm = TRUE)
