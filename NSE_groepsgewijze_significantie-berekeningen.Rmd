...
for (i_vraag in vec_NSEvragen)
  ...
  gem_HU1[i_vraag-Ncor]  <- t.test(HUscores[,i_vraag], R5scores[,i_vraag])$estimate[1]
...
temp1 <- data.frame(Opleidingsvorm3  = rep("",Nvragen), 
                   CrohoActueel      = rep("",Nvragen), 
                   Vraag             = NSEvragen, 
                   Benchmark         = rep("R5",Nvragen),  
                   p                 = p_HUR5_adj, 
                   Niveau            = rep("HU",Nvragen))

temp2 <- data.frame(Opleidingsvorm3  = rep("",Nvragen),
                   CrohoActueel      = rep("",Nvragen),
                   Vraag             = NSEvragen,
