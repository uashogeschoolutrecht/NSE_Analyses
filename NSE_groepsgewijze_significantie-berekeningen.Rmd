...
for (i_vraag in vec_NSEvragen)
  {
  #Berekenen p waarden
  p_HUR6[i_vraag-Ncor]      <- t.test(HUscores[vec_vorm[[i_vorm]],i_vraag],                                           R6scores[vec_vorm[[i_vorm]],i_vraag]                                           )$p.value
  p_HUAlle[i_vraag-Ncor]    <- t.test(HUscores[vec_vorm[[i_vorm]],i_vraag],                                           Allescores[vec_vorm[[i_vorm]],i_vraag]                                         )$p.value
