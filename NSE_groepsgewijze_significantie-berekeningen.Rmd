...
p_HUAlle    <- matrix(NA, Nvragen, Nvorm)
...
for (i_vorm in 1:Nvorm)
{
  ...
  for (i_vraag in vec_NSEvragen)
  {
    ...
    p_HUAlle[i_vraag-Ncor,i_vorm]<- t.test(HUscores[vec_vorm[[i_vorm]],i_vraag],                                            Allescores[vec_vorm[[i_vorm]]                                                   ,i_vraag])$p.value
    #Berekenen gemiddelden per groep
    gem_HU[i_vraag-Ncor]      <- t.test(HUscores[vec_vorm[[i_vorm]],i_vraag],                                           R6scores[vec_vorm[[i_vorm]],i_vraag]                                           )$estimate[1]
    gem_R6[i_vraag-Ncor]      <- t.test(HUscores[vec_vorm[[i_vorm]],i_vraag],                                           R6scores[vec_vorm[[i_vorm]],i_vraag]                                           )$estimate[2]
    gem_Alle[i_vraag-Ncor]    <- t.test(HUscores[vec_vorm[[i_vorm]],i_vraag],                                           Allescores[vec_vorm[[i_vorm]],i_vraag]                                         )$estimate[2]
