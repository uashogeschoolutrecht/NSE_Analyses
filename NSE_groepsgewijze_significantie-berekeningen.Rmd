...
p_HUR6_w    <- array(NA, c(Nvragen, int_vorm, NHO, Ncrohos))
p_HUAL      <- array(NA, c(Nvragen, int_vorm, NHO, Ncrohos))
p_HUAL_w    <- array(NA, c(Nvragen, int_vorm, NHO, Ncrohos))
N_HU        <- array(NA, c(Nvragen, int_vorm, NHO, Ncrohos))
N_R6        <- array(NA, c(Nvragen, int_vorm, NHO, Ncrohos))
N_AL        <- array(NA, c(Nvragen, int_vorm, NHO, Ncrohos))
gem_HU      <- array(NA, c(Nvragen, int_vorm, NHO, Ncrohos))
gem_R6      <- array(NA, c(Nvragen, int_vorm, NHO, Ncrohos))
gem_AL      <- array(NA, c(Nvragen, int_vorm, NHO, Ncrohos))
diff_HUR6   <- array(NA, c(Nvragen, int_vorm, NHO, Ncrohos))
diff_HUAL   <- array(NA, c(Nvragen, int_vorm, NHO, Ncrohos))
