...
load("~/researchdrive/M21033303_DenA (Projectfolder)/DA_Onderzoek/2022nse/data_in/NSE2022 nse_benchmark_clean.RData")
...
HUscores <- nse_benchmark_clean[nse_benchmark_clean$BrinNaamActueel == "Hogeschool Utrecht",c("UniekNummer", "Weegfactor", "CrohoNaamActueel", "SoortHo", "BaMa", "Opleidingsvorm3",str_NSEvragen[c(vec_rwauitkomst, vec_rwavariabelen)])]
...
write.csv(prioriteitenmatrix,file = "~/researchdrive/M21033303_DenA (Projectfolder)/DA_Onderzoek/2022nse/data_uit/NSEprioriteitenttabel2022.csv")
```
