...
rwa_scores_gem   <- mean(rwa_scores)
rwa_bijdrage_gem <- mean(rwa_bijdrage[idx_vorm,])

plot(rwa_bijdrage[idx_vorm,], 
     rwa_scores[idx_vorm,], 
...
abline(h=rwa_scores_gem, #Gemiddelden horizontale en verticale lijnen zodra de matrix vorm krijgt
       v=rwa_bijdrage_gem, 
       col="black")
text(rwa_bijdrage[idx_vorm,], #Toevoegen nummer van vraag aan plot
     rwa_scores, 
