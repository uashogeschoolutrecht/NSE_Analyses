      ...
      else
      {
        ...
        rwa_resultaten <- HUscores_clean[vec_vorm[[idx_vorm]]&
          ...
          rwa(outcome    = NSEvragen[vec_rwauitkomst],
              ...
              applysigns = TRUE)
        rwa_bijdrage[idx_vorm,idx_ho,idx_croho,] <- rwa_resultaten$result$Sign.Rescaled.RelWeight #Bijdrage aan de totaalscore
...
rwa_scores_gem   <- mean(rwa_scores[idx_vorm,idx_ho,])
rwa_bijdrage_gem <- mean(rwa_bijdrage[idx_vorm,idx_ho,])

plot(rwa_bijdrage[idx_vorm,idx_ho,], 
     rwa_scores[idx_vorm,idx_ho,], 
...
abline(h=rwa_scores_gem, #Gemiddelden horizontale en verticale lijnen zodra de matrix vorm krijgt
       v=rwa_bijdrage_gem, 
       col="black")
text(rwa_bijdrage[idx_vorm,idx_ho,], #Toevoegen nummer van vraag aan plot
     rwa_scores[idx_vorm,idx_ho,], 
...
for (idx_ho in 1:NHO)
{
  for (idx_vorm in 1:Nvorm)
  {
    tmp <- data.frame(Opleidingsvorm3 = NSEvormen[idx_vorm],
                      ...
                      RWAscores       = rwa_scores[idx_vorm,idx_ho,],
                      RWAbijdrage     = rwa_bijdrage[idx_vorm,idx_ho,],
                      N               = N[idx_vorm,idx_ho])
